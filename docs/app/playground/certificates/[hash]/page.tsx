...
export default async function CertificateDetailPage({ params }: { params: Promise<{ hash: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Link href="/playground/certificates" className="text-xs text-fd-muted-foreground hover:text-fd-foreground mb-2 inline-block">
        ...
        <div className="rounded-lg border border-fd-border bg-fd-card p-5 space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <Link href={`/playground/agents/${cert.agent}`} className="hover:underline">
