          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-lg border border-fd-border bg-fd-card">
              <div className="px-4 py-3 border-b border-fd-border flex items-center justify-between">
                ...
                <Link href="/dashboard/all-agents" className="text-xs text-fd-primary hover:underline">View all</Link>
              </div>
            ...
            <div className="rounded-lg border border-fd-border bg-fd-card">
              <div className="px-4 py-3 border-b border-fd-border flex items-center justify-between">
                ...
                <Link href="/dashboard/all-certificates" className="text-xs text-fd-primary hover:underline">View all</Link>
              </div>
              <div className="divide-y divide-fd-border/50">
            ...
            <div className="rounded-lg border border-fd-border bg-fd-card">
              <div className="px-4 py-3 border-b border-fd-border flex items-center justify-between">
                ...
                <Link href="/dashboard/auditor-board" className="text-xs text-fd-primary hover:underline">View all</Link>
              </div>
              <div className="divide-y divide-fd-border/50">
                {state.auditors.slice(0, 5).map((auditor) => (
                  <Link
                    key={auditor.address}
                    href={`/dashboard/auditor-board`}
                    className="flex items-center justify-between px-4 py-2.5 hover:bg-fd-muted/30 transition-colors"
                  >
